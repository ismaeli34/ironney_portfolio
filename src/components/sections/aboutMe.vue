    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      >
        <img
          ...
          alt="Headshot of Ronney facing a camera"
        />
      </div>
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          Driven by a passion for design and development,
          I transform ideas into fully realized digital experiences,
          guiding projects from concept to launch to create a lasting,
          positive impact on both the digital landscape and your business.
        </p>
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
            ...
            <br /><br />
            On the frontend, I work with <strong>Angular, React, Vue.js, Next.js and SAPUI5</strong>, while on the backend I leverage <strong> Java, and Spring Boot</strong> to build robust, scalable applications.
            <br /><br />
            When I'm not immersed in web development and design, you can find me sharing insights about my freelance journey on <i>&Xopf;</i>, loudly playing music (Funk), or just relaxing.
          </p>
        </div>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  import { profile4} from '@/assets/images';
