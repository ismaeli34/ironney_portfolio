  ...
  const selectedWorksProps = [
    {
      name: 'Airbnb',
      category: 'Frontend',
      tags: ['Angular', 'Html', 'NGPrime', 'CSS', 'Bootstrap', 'Java'],
      videoSrc: airbnb,
      imageBg: workBg5,
      url: 'https://github.com/ismaeli34/Airbnb_Project',
      year: '2025',
    },
    {
      name: 'Iphone 15 Clone',
      category: 'Frontend & Animation & 3D',
      tags: ['Animation', '3D','React.js'],
      videoSrc: work2,
      imageBg: workBg2,
      url: 'https://github.com/ismaeli34/iCloneX',
      year: '2025',
    },
    {
      name: 'Exam Portal',
      category: 'Frontend & Documentation',
      tags: ['Angular', 'CSS', 'Bootstrap','HTML', 'Java','Springboot'],
      videoSrc: quizapp,
      imageBg: workBg3,
      url: 'https://github.com/ismaeli34/AngularQuizApplication',
      year: '2023',
    },
    {
      name: 'SDA Church',
